...
type AuthState = {
  ...
  hydrated: boolean;
  setSession: (token: string, refreshToken: string, user: DashboardUser) => void;
...
function persist(state: { token: string | null; refreshToken: string | null; user: DashboardUser | null }) {
